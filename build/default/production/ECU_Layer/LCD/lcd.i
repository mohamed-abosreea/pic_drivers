...
# 11 "ECU_Layer/LCD/lcd.h"
# 1 "ECU_Layer/LCD/lcd_cfg.h" 1
# 11 "ECU_Layer/LCD/lcd.h" 2
...
# 17 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../Device_Config/device_config.h"
...
# 74 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../Device_Config/device_config.h" 2
# 12 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/gpio.h" 2


# 1 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../../std_types.h" 1
# 11 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../../std_types.h"
...
typedef float f32 ;
typedef double f64 ;
# 35 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../../std_types.h"
typedef enum
{
    OK = 1 ,
    N_OK = 0
...
# 1 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../../std_lib.h" 1
...
Err_check_t lcd_init(const lcd_t *lcd) {
    ...
    if (((void*)0) == lcd) {
        ...
        if (lcd ->lcd_connection == _4_BIT) {
            ...
            e_check &= lcd_send_command(lcd, 0x38);
            _delay((unsigned long)((5)*(8000000UL/4000.0)));
            e_check &= lcd_send_command(lcd, 0x38);
            _delay((unsigned long)((150)*(8000000UL/4000000.0)));
            e_check &= lcd_send_command(lcd, 0x38);

            e_check &= lcd_send_command(lcd, 0x02);
            e_check &= lcd_send_command(lcd, 0x0C);
            e_check &= lcd_send_command(lcd, 0x01);
            e_check &= lcd_send_command(lcd, 0x06);
            e_check &= lcd_send_command(lcd, 0x28);
...
Err_check_t lcd_send_command(const lcd_t *lcd, uint8 command) {
    ...
    if (((void*)0) == lcd) {
        ...
        if (lcd->lcd_connection == _4_BIT) {
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[0]), ((command >> 4) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[1]), ((command >> 5) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[2]), ((command >> 6) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[3]), ((command >> 7) & 1));
            ...
            _delay((unsigned long)((5)*(8000000UL/4000000.0)));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[0]), (((command) >> 0) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[1]), (((command) >> 1) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[2]), (((command) >> 2) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[3]), (((command) >> 3) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_en), HIGH);
            _delay((unsigned long)((5)*(8000000UL/4000000.0)));
            e_check &= gpio_pin_set_state(&(lcd->lcd_en), LOW);
            _delay((unsigned long)((5)*(8000000UL/4000000.0)));
            ...
            for (uint8 count = 0; count < 8; count++) {
                e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[count]), ((command >> count) & 1));
            }
            e_check &= gpio_pin_set_state(&(lcd->lcd_en), HIGH);
            _delay((unsigned long)((5)*(8000000UL/4000000.0)));
            e_check &= gpio_pin_set_state(&(lcd->lcd_en), LOW);
...
Err_check_t lcd_send_chr(const lcd_t *lcd, uint8 character) {
    ...
    if (((void*)0) == lcd) {
        ...
        if (lcd->lcd_connection == _4_BIT) {
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[0]), ((character >> 4) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[1]), ((character >> 5) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[2]), ((character >> 6) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[3]), ((character >> 7) & 1));

            e_check &= gpio_pin_set_state(&(lcd->lcd_en), HIGH);
            _delay((unsigned long)((10)*(8000000UL/4000000.0)));
            e_check &= gpio_pin_set_state(&(lcd->lcd_en), LOW);

            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[0]), (((character) >> 0) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[1]), (((character) >> 1) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[2]), (((character) >> 2) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[3]), (((character) >> 3) & 1));
            e_check &= gpio_pin_set_state(&(lcd->lcd_en), HIGH);
            _delay((unsigned long)((10)*(8000000UL/4000000.0)));
            e_check &= gpio_pin_set_state(&(lcd->lcd_en), LOW);
        } else if (lcd->lcd_connection == _8_BIT) {
            for (uint8 count = 0; count < 8; count++) {
                e_check &= gpio_pin_set_state(&(lcd->lcd_data_pins[count]), ((character >> count) & 1));
            }
            e_check &= gpio_pin_set_state(&(lcd->lcd_en), HIGH);
            _delay((unsigned long)((10)*(8000000UL/4000000.0)));
            e_check &= gpio_pin_set_state(&(lcd->lcd_en), LOW);
...
Err_check_t lcd_send_custome_chr_pos(const lcd_t *lcd, uint8 * arr[], uint8 mem_pos, row_t row, col_t col) {
    Err_check_t e_check = OK;
    if (((void*)0) == lcd || ((void*)0) == arr) {
        e_check = N_OK;
    } else {
        e_check &= lcd_send_command(lcd, (0x40 + (mem_pos * 8)));
        for(uint8 count = 0 ; count < 8 ;count++)
        {
