# 1 "ECU_Layer/SEVEN_SEG/seven_seg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_Layer/SEVEN_SEG/seven_seg.c" 2
...
# 1 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/gpio.h" 1
# 12 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/gpio.h"
# 1 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/../Device_Config/device_config.h" 1
# 17 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/../Device_Config/device_config.h"
...
# 74 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/../Device_Config/device_config.h" 2
# 12 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/gpio.h" 2


# 1 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/../../std_types.h" 1
# 11 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/../../std_types.h"
...
typedef float f32 ;
typedef double f64 ;
# 35 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/../../std_types.h"
typedef enum
{
    OK = 1 ,
    N_OK = 0
}Err_check_t;
# 14 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/gpio.h" 2

# 1 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/../../std_lib.h" 1
# 15 "ECU_Layer/SEVEN_SEG/../../MCAL_Layer/GPIO/gpio.h" 2
...
# 22 "ECU_Layer/SEVEN_SEG/seven_seg.h"
typedef enum {
    COMMON_ANODE = 0,
    COMMON_CATHODE
} seven_seg_type_t;
...
# 2 "ECU_Layer/SEVEN_SEG/seven_seg.c" 2
...
Err_check_t seven_seg_write_num(const seven_seg_t* seven_seg , uint8 Num) {
    Err_check_t e_check = OK;
    if (((void*)0) == seven_seg || Num > 9 || Num < 0) {
        e_check = N_OK;
    } else {
        switch (seven_seg ->seven_seg_type) {
            case COMMON_ANODE:
                e_check &= gpio_pin_set_state(&(seven_seg->seven_seg_pins[0]) , ((Num >> 0) & 1));
                e_check &= gpio_pin_set_state(&(seven_seg->seven_seg_pins[1]) , ((Num >> 1) & 1));
                e_check &= gpio_pin_set_state(&(seven_seg->seven_seg_pins[2]) , ((Num >> 2) & 1));
                e_check &= gpio_pin_set_state(&(seven_seg->seven_seg_pins[3]) , ((Num >> 3) & 1));
                break;
            case COMMON_CATHODE:
                e_check &= gpio_pin_set_state(&(seven_seg->seven_seg_pins[0]) , !((Num >> 0) & 1));
                e_check &= gpio_pin_set_state(&(seven_seg->seven_seg_pins[1]) , !((Num >> 1) & 1));
