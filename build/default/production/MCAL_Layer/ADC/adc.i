...
# 12 "MCAL_Layer/ADC/../GPIO/gpio.h"
# 1 "MCAL_Layer/ADC/../GPIO/../Device_Config/device_config.h" 1
# 17 "MCAL_Layer/ADC/../GPIO/../Device_Config/device_config.h"
...
# 74 "MCAL_Layer/ADC/../GPIO/../Device_Config/device_config.h" 2
# 12 "MCAL_Layer/ADC/../GPIO/gpio.h" 2
# 22 "MCAL_Layer/ADC/../GPIO/gpio.h"
typedef enum
{
    INPUT = 1 ,
    OUTPUT = 0
...
# 1 "MCAL_Layer/ADC/../Interrupt_Manager/interrupt_cfg.h" 1
# 41 "MCAL_Layer/ADC/../Interrupt_Manager/interrupt_cfg.h"
typedef enum {
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
...
Err_check_t adc_init(const adc_cfg_t *adc) {
    ...
    if (adc == ((void*)0)) {
        ...
        (ADCON2bits.ADFM = adc->result_format);

        (ADCON1bits.VCFG = adc->voltage_ref);
...
Err_check_t adc_isConversionDone(const adc_cfg_t *adc, uint8 *status) {
    Err_check_t e_check = OK;
    if (adc == ((void*)0) || status == ((void*)0)) {
        e_check = N_OK;
    } else {

        *status = (uint8)!(ADCON0bits.GODONE);
    }
    return e_check;
}
...
Err_check_t static adc_portConfiguration(adc_channel_select_t channel) {
    ...
    switch (channel) {
        ...
        case ADC_CHANNEL_AN5:
            (ADCON1bits.PCFG = (0x09));
            (TRISE |= (1<<0));
            break;
        case ADC_CHANNEL_AN6:
            (ADCON1bits.PCFG = (0x08));
            (TRISE |= (1<<1));
            break;
        ...
        case ADC_CHANNEL_AN11:
            (ADCON1bits.PCFG = (0x03));
            (TRISB |= (1<<4));
            break;
        case ADC_CHANNEL_AN12:
            (ADCON1bits.PCFG = (0x02));
            (TRISB |= (1<<0));
            break;
        default:
            e_check = N_OK;
