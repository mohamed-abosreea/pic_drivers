...
# 11 "MCAL_Layer/TIMER1/timer1.h"
# 1 "MCAL_Layer/TIMER1/../Device_Config/device_config.h" 1
# 17 "MCAL_Layer/TIMER1/../Device_Config/device_config.h"
...
# 74 "MCAL_Layer/TIMER1/../Device_Config/device_config.h" 2
# 11 "MCAL_Layer/TIMER1/timer1.h" 2

# 1 "MCAL_Layer/TIMER1/../GPIO/gpio.h" 1
# 14 "MCAL_Layer/TIMER1/../GPIO/gpio.h"
...
typedef float f32 ;
typedef double f64 ;
# 35 "MCAL_Layer/TIMER1/../GPIO/../../std_types.h"
typedef enum
{
    OK = 1 ,
    N_OK = 0
...
# 1 "MCAL_Layer/TIMER1/../GPIO/../../std_lib.h" 1
...
# 1 "MCAL_Layer/TIMER1/../Interrupt_Manager/interrupt_cfg.h" 1
# 41 "MCAL_Layer/TIMER1/../Interrupt_Manager/interrupt_cfg.h"
typedef enum {
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
...
void (*Timer1_InterruptHandler)(void) = ((void*)0);
...
# 189 "MCAL_Layer/TIMER1/timer1.c"
static Err_check_t timer_checkInterrupt(const timer1_t *timer1)
{
    Err_check_t e_check = OK;
    if (timer1 == ((void*)0)) {
        ...
        if (timer1 ->t1_IntMode == TIMER1_INTERRUPT_OFF) {
            (PIR1bits.TMR1IF = 0);
            (PIE1bits.TMR1IE = 0);
        } else if (timer1 ->t1_IntMode == TIMER1_INTERRUPT_ON || timer1 ->InterruptHandler == ((void*)0)) {
            Timer1_InterruptHandler = timer1->InterruptHandler;
            (PIR1bits.TMR1IF = 0);
# 210 "MCAL_Layer/TIMER1/timer1.c"
            (INTCONbits.GIE =1);
            (INTCONbits.PEIE =1);
            (PIE1bits.TMR1IE = 1);
