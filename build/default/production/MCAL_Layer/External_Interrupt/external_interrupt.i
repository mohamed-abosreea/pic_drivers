# 1 "MCAL_Layer/External_Interrupt/external_interrupt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/External_Interrupt/external_interrupt.c" 2
# 1 "MCAL_Layer/External_Interrupt/external_interrupt.h" 1
# 11 "MCAL_Layer/External_Interrupt/external_interrupt.h"
# 1 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/interrupt_cfg.h" 1
# 12 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/interrupt_cfg.h"
# 1 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/../../std_lib.h" 1
# 12 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/interrupt_cfg.h" 2

# 1 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/../../std_types.h" 1
# 11 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/../../std_types.h"
...
typedef float f32 ;
typedef double f64 ;
# 35 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/../../std_types.h"
typedef enum
{
    OK = 1 ,
    N_OK = 0
}Err_check_t;
# 13 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/interrupt_cfg.h" 2
...
# 14 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/interrupt_cfg.h" 2
# 41 "MCAL_Layer/External_Interrupt/../Interrupt_Manager/interrupt_cfg.h"
typedef enum {
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
...
void TIMER0_ISR();
void TIMER1_ISR();
# 11 "MCAL_Layer/External_Interrupt/external_interrupt.h" 2

# 1 "MCAL_Layer/External_Interrupt/../GPIO/gpio.h" 1
# 12 "MCAL_Layer/External_Interrupt/../GPIO/gpio.h"
# 1 "MCAL_Layer/External_Interrupt/../GPIO/../Device_Config/device_config.h" 1
# 17 "MCAL_Layer/External_Interrupt/../GPIO/../Device_Config/device_config.h"
...
# 74 "MCAL_Layer/External_Interrupt/../GPIO/../Device_Config/device_config.h" 2
# 12 "MCAL_Layer/External_Interrupt/../GPIO/gpio.h" 2
# 22 "MCAL_Layer/External_Interrupt/../GPIO/gpio.h"
typedef enum
{
    INPUT = 1 ,
    OUTPUT = 0
...
# 12 "MCAL_Layer/External_Interrupt/external_interrupt.h" 2
# 59 "MCAL_Layer/External_Interrupt/external_interrupt.h"
typedef enum {
    FALLING = 0,
    RISING
...
# 152 "MCAL_Layer/External_Interrupt/external_interrupt.c"
static Err_check_t interrupt_INTx_Edge_Cfg(const interrupt_intx_t *intx_obj) {
    Err_check_t e_check = OK;
    if (((void*)0) == intx_obj) {
        e_check = N_OK;
...
static Err_check_t interrupt_INTx_SetHandler(const interrupt_intx_t *intx_obj) {
    ...
    if (intx_obj == ((void*)0)) {
        ...
        switch (intx_obj ->int_src) {
            case INT_0:
                if (intx_obj ->EXT_InterruptHandler != ((void*)0)) {
