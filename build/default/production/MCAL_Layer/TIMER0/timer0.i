...
typedef float f32 ;
typedef double f64 ;
# 35 "MCAL_Layer/TIMER0/../../std_types.h"
typedef enum
{
    OK = 1 ,
    N_OK = 0
...
# 1 "MCAL_Layer/TIMER0/../Device_Config/device_config.h" 1
# 17 "MCAL_Layer/TIMER0/../Device_Config/device_config.h"
...
# 74 "MCAL_Layer/TIMER0/../Device_Config/device_config.h" 2
# 14 "MCAL_Layer/TIMER0/timer0.h" 2

# 1 "MCAL_Layer/TIMER0/../Interrupt_Manager/interrupt_cfg.h" 1
# 41 "MCAL_Layer/TIMER0/../Interrupt_Manager/interrupt_cfg.h"
typedef enum {
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
...
# 22 "MCAL_Layer/TIMER0/../GPIO/gpio.h"
typedef enum
{
    INPUT = 1 ,
    OUTPUT = 0
...
Err_check_t timer0_init(timer0_t *timer)
{
    ...
    if(timer == ((void*)0))
    {
        ...
        if(timer->timer0_mode == TIMER0_TIMER)
        {
            ...
            {
               (T0CONbits.PSA = 0);
               (T0CONbits.T0PS = timer->prescalar_value);
            }else{
               (T0CONbits.PSA = 1);
            }
